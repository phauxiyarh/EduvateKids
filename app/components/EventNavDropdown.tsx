...
export function EventNavDropdown({ active = false }: { active?: boolean }) {
  ...
  return (
    <div ref={ref} className="relative" onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
      ...
      <div
        role="menu"
        className={`absolute left-0 top-full z-50 mt-2 w-52 origin-top overflow-hidden rounded-2xl border border-primary/10 bg-white/95 shadow-[0_16px_40px_rgba(124,58,237,0.16)] backdrop-blur-xl transition-all duration-200 ${
