...
/**
 * Floating cart button — appears on storefront pages whenever the cart has items.
 * Hidden on checkout/confirmation and admin pages (where it would be redundant/out of place).
 */
export function CartFab() {
  ...
  if (count === 0 || hiddenOn.some((p) => pathname.startsWith(p))) return null
